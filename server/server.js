...
app.prepare().then(async () => {
  ...
  router.get("/report-list", async(ctx) => {
    console.log('insied apie call');
    let header = {
    ...
    let result = await axios.get(`https://api.airtable.com/v0/${AIRTABLEBASEID}/${AIRTABLETABLENAME}?maxRecords=&view=Grid%20view`,header);
